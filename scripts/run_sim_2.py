...
def main(args=None):
    ...
    # ego_sim_dynamics_config = DynamicBicycleConfig(dt=0.01,
    #                                         model_name='dynamic_bicycle',
    #                                         noise=False,
    #                                         discretization_method=discretization_method,
    #                                         simple_slip=False,
    ...
    # tar_history, ego_history, vehiclestate_history, ego_sim_state, tar_sim_state, egost_list, tarst_list = \
    #     run_pid_warmstart(scenario, ego_dynamics_simulator, tar_dynamics_simulator, n_iter=N+1, t=t)
    
    # ego_history_actuation = VehicleActuation()
    # tar_history_actuation = VehicleActuation()
    # ego_dynamics_model.u2input(ego_history_actuation, ego_history[0][-1])
    # tar_dynamics_model.u2input(tar_history_actuation, tar_history[0][-1])
    ...
    # ego_u_ws = np.tile(ego_dynamics_model.input2u(ego_history_actuation), (N+1, 1))
    ...
    # egopred_list = [None] * (N+1)
    # tarpred_list = [None] * (N+1)
